...
from .views import (
    TrackSearchView, TrackPageViewView, TrackCartEventView, TrackAbandonmentView,
    AnalyticsDashboardView, SearchTrafficView, CartAbandonmentListView,
    NewCustomersView, DailySummaryView, SupervisorDashboardView,
)
