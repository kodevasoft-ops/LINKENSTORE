...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(name='User', fields=[
            ...
            ('role', models.CharField(max_length=25, default='customer', choices=[
                ('customer', 'Cliente'),
                ('vendedor', 'Vendedor'),
        ...
        migrations.AddIndex(model_name='user', index=models.Index(fields=['role'], name='core_user_role_idx')),
        migrations.AddIndex(model_name='user', index=models.Index(fields=['email'], name='core_user_email_idx')),
        ...
        migrations.AddIndex(model_name='auditlog', index=models.Index(fields=['user', 'created_at'], name='core_audit_user_created_idx')),
    ]
