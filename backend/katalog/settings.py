...
# NOTA: antes esto era '-c default_transaction_isolation=read committed',
# pero libpq separa el valor de `options` por espacios en blanco (no respeta
# el espacio dentro de "read committed" sin escapar), así que Postgres solo
# recibía "read" como valor -> "invalid value for parameter" y la conexión
# fallaba SIEMPRE. Se usa `isolation_level` de psycopg2 en su lugar, que es
# la forma correcta y soportada de fijar el nivel de aislamiento.
